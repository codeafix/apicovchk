...
func TestParseTransactionLogEntry(t *testing.T) {
	ll := "1828	18:57.8	18:59.7	POST	http://127.0.0.1:58800/orchestration/customers/FunctionalTestCompany/reporting-entities/32a7e0b0-8130-4ab1-ace0-a81000890a14/gocompatible-financial-periods	\"{\"\"startDate\"\":\"\"2016-12-31\"\",\"\"endDate\"\":\"\"2017-12-30\"\",\"\"publishedId\"\":\"\"0af343ae-4468-44e5-98aa-897e6e6c5458\"\"}\"	201"
	tlr := &LogReaderInfo{}
	...
	AreEqual(t, "http://127.0.0.1:58800/orchestration/customers/FunctionalTestCompany/reporting-entities/32a7e0b0-8130-4ab1-ace0-a81000890a14/gocompatible-financial-periods", tle.URL.String(), "URL not correct")
	AreEqual(t, "/customers/FunctionalTestCompany/reporting-entities/32a7e0b0-8130-4ab1-ace0-a81000890a14/gocompatible-financial-periods", tle.Path, "Path not correct")
...
func TestParseTransactionLogEntryElems1(t *testing.T) {
	ll := "1828	18:57.8	18:59.7	get	http://127.0.0.1:58800/orchestration/customers/FunctionalTestCompany/reporting-entities	undefined	201"
	tlr := &LogReaderInfo{}
	tle, err := tlr.ParseTransactionLogEntry(ll)
	AssertSuccess(t, err)
	AreEqual(t, "GET", tle.Method, "Method not correct")
	AreEqual(t, 3, len(tle.PathElements), "Wrong number of path elements")
	AreEqual(t, "customers", tle.PathElements[0], "Path element 0 not correct")
	AreEqual(t, "FunctionalTestCompany", tle.PathElements[1], "Path element 1 not correct")
	AreEqual(t, "reporting-entities", tle.PathElements[2], "Path element 2 not correct")
}
...
func TestParseTransactionLogEntryElems3(t *testing.T) {
	ll := "1828	18:57.8	18:59.7	get	http://127.0.0.1:58800/test-authentication/?role=BFTUser1&session=Active	undefined	201"
	tlr := &LogReaderInfo{}
	tle, err := tlr.ParseTransactionLogEntry(ll)
	AssertSuccess(t, err)
	AreEqual(t, "GET", tle.Method, "Method not correct")
...
func TestParseTransactionLogEntryWorksWithRelativePath(t *testing.T) {
	ll := "1828	18:57.8	18:59.7	POST	orchestration/customers/FunctionalTestCompany/reporting-entities/32a7e0b0-8130-4ab1-ace0-a81000890a14/gocompatible-financial-periods	\"{\"\"startDate\"\":\"\"2016-12-31\"\",\"\"endDate\"\":\"\"2017-12-30\"\",\"\"publishedId\"\":\"\"0af343ae-4468-44e5-98aa-897e6e6c5458\"\"}\"	404"
	tlr := &LogReaderInfo{}
	tle, err := tlr.ParseTransactionLogEntry(ll)
	AssertSuccess(t, err)
	AreEqual(t, "orchestration/customers/FunctionalTestCompany/reporting-entities/32a7e0b0-8130-4ab1-ace0-a81000890a14/gocompatible-financial-periods", tle.URL.String(), "URL not correct")
	AreEqual(t, "/customers/FunctionalTestCompany/reporting-entities/32a7e0b0-8130-4ab1-ace0-a81000890a14/gocompatible-financial-periods", tle.Path, "Path not correct")
	AreEqual(t, "orchestration", tle.Service, "Service not correct")
}

func TestParseTransactionLogEntryReportsFailsWhenDurationNaN(t *testing.T) {
	ll := "whatever	18:57.8	18:59.7	POST	orchestration/customers/FunctionalTestCompany/reporting-entities/32a7e0b0-8130-4ab1-ace0-a81000890a14/gocompatible-financial-periods	\"{\"\"startDate\"\":\"\"2016-12-31\"\",\"\"endDate\"\":\"\"2017-12-30\"\",\"\"publishedId\"\":\"\"0af343ae-4468-44e5-98aa-897e6e6c5458\"\"}\"	404"
	tlr := &LogReaderInfo{}
...
func TestParseTransactionLogEntryQuery(t *testing.T) {
	ll := "663	18:55.0	18:55.6	GET	http://127.0.0.1:58800/test-authentication/?role=BFTUser1&session=Active	undefined	200"
	tlr := &LogReaderInfo{}
	tle, err := tlr.ParseTransactionLogEntry(ll)
	AssertSuccess(t, err)
	role, exists := tle.Query["role"]
	IsTrue(t, exists, "role query parameter does not exist")
	AreEqual(t, "BFTUser1", role[0], "BFTUser1 not role parameter value")
